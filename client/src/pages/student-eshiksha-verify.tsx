...
export default function StudentEshikshaVerify() {
    const [enrollmentNo, setEnrollmentNo] = useState("");
    const [dateOfBirth, setDateOfBirth] = useState("");

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // TODO: wire to E Shiksha enrollment verification API
    };
                ...
                <div className="container-pad">
                    <div className="max-w-lg mx-auto">
                        ...
                        <div className="text-center mb-10">
                            <div className="flex items-center justify-center gap-3 mb-4">
                                ...
                                <h1 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
                                    E Shiksha Enrollment Verification
                                </h1>
                            </div>
                            <div
                        ...
                        <p className="mt-6 text-center text-sm text-slate-500">
                            Enter your enrollment number and date of birth to verify your E Shiksha enrollment.
                        </p>
                    </div>
                </div>
            </main>
