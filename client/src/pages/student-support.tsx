...
export default function StudentSupport() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // TODO: wire to support center access API
    };
                ...
                <div className="container-pad">
                    <div className="max-w-lg mx-auto">
                        ...
                        <div className="text-center mb-10">
                            <div className="flex items-center justify-center gap-3 mb-4">
                                ...
                                <h1 className="font-display text-3xl tracking-tight text-slate-900 sm:text-4xl">
                                    Student&apos;s Support Center
                                </h1>
                            </div>
                            <p className="text-slate-500 text-sm font-medium mb-3">Login</p>
                            <div
                        ...
                        <p className="mt-6 text-center text-sm text-slate-500">
                            Enter your enrollment number and date of birth to access the support center.
                        </p>
                    </div>
                </div>
            </main>
