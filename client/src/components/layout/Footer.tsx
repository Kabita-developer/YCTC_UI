        ...
        <footer id="footer" className="bg-hero noise-overlay text-white" data-testid="footer">
            <div className="container-pad py-14">
                <div className="grid gap-10 md:grid-cols-4">
                    <div data-testid="footer-brand">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <div className="font-display text-lg">EducateX</div>
                                <div className="text-xs text-white/70">Learning that ships outcomes</div>
                            </div>
                        </div>
                        <p className="mt-4 text-sm text-white/75" data-testid="text-footer-desc">
                            A premium online learning experience with structured programs, mentors, and community — built to help you grow your learning.
                        </p>
                    ...
                    <div data-testid="footer-contact">
                        ...
                        <div className="mt-4 grid gap-3 text-sm text-white/80">
                            <div className="flex items-start gap-3" data-testid="row-footer-address">
                                ...
                                <span data-testid="text-footer-address">12 University Ave, Learning City</span>
                            </div>
                            ...
                            <div className="flex items-start gap-3" data-testid="row-footer-email">
                                ...
                                <span data-testid="text-footer-email">support@educatex.edu</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-6 text-xs text-white/70 md:flex-row" data-testid="footer-bottom">
                    <div data-testid="text-footer-copyright">© {new Date().getFullYear()} EducateX. All rights reserved.</div>
