 ...
 * Usage: node client/scripts/gen-centers-data.js [centers.tsv]
 *   With file: reads TSV from path (relative to project root or absolute).
 *   Without: reads TSV from stdin.
 */
const fs = require('fs');
